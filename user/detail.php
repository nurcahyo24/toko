    ...
    <div class="col-md-12 mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="jawab_komentar.php">


                    <div class="form-group">
                        <label for="exampleInputEmail1">Masukan Komentar</label>
                        <textarea class="form-control" name="komentar" placeholder="Masukan Komentar..." rows="3"></textarea>
                        <input type="hidden" name="id_produk" value="<?= $produk->id_produk ?>">
                    </div>
