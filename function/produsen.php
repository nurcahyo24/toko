...
function detailProduk($id)
{
    ...
    $data = [
        'true'      => true,
        'judul'     => 'Detail Barang | Halaman produsen',
...
function tambahProduk($post)
{
    ...
    if (isset(_validation($data)['pesan'])) {
        header('location:' . url . 'produsen/tambahProduk.php/?pesan=' . _validation($data)['pesan']);
        die;
    }
    ...
    if (mysqli_affected_rows($konek)) {
        ...
        return header('location:' . url . 'produsen/produk.php/?pesan=Data berhasil ditambahkan');
    } else {
        echo "errror";
        die;
    }
...
function ubahProduk($id, $post)
{
    ...
    if (isset(_validation($data)['pesan'])) {
        ...
        return header('location:' . url . 'produsen/detailProduk.php/?id=' . $id);
    }
    _hapusSession();
    ...
    if ($sql > 0) {
        return header('location:' . url . 'produsen/produk.php/?pesan=Data berhasil Diubah');
    }
...
function verifiTransaksi($id)
{
    ...
    return header('location:' . url . 'produsen/transaksi.php');
}
...
function hapusPengguna($id)
{
    ...
    return header('location:' . url . 'produsen/pengguna.php');
}
