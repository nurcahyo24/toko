    ...
    <div class="card w-100 text-dark ">
        ...
        <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
            <div class="row">
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <input class="form-control" type="text" name="nama" id="nama"
                        value="<?= (isset($_SESSION['nama'])) ? $_SESSION['nama'] :  "" ?>">
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
                <div class="form-group mx-2 col-sm-5 ">
                    <label for="harga">harga</label>
                    <input class="form-control" type="number" name="harga" id="harga"
                        value="<?= (isset($_SESSION['harga'])) ? $_SESSION['harga'] :  "" ?>">
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <input class="form-control" type="number" name="stok" id="stok"
                        value="<?= (isset($_SESSION['stok'])) ? $_SESSION['stok'] :  "" ?>">
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
            </div>
            <div class="row">
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <textarea class="form-control" type="text" name="deskripsi"
                        id="deskripsi"><?= (isset($_SESSION['deskripsi'])) ? $_SESSION['deskripsi'] :  "" ?></textarea>
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class=" text-center my-3">
                <button type="submit" name="simpan" class="btn btn-sm btn-primary w-25" href="#"
                    class="card-link">Simpan</button>
                <a href="<?= url ?>admin/detailProduk.php/?id=<?= $produk['produk']->id_produk ?>"
                    class="btn btn-sm btn-danger w-25" class="card-link">Batal</a>
            </div>
        </form>
    </div>
</div>
