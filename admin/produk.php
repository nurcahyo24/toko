...
<div class="produk my-2 py-2 bg-primary text-light ">
    ...
    <ul class="list-group text-dark">
        ...
        <li class="list-group-item d-flex">
            ...
            <span class="col"><a href="<?= url ?>admin/detailProduk.php/?id=<?= $value->id_produk ?>"
                    class="text-decoration-none" style="cursor: pointer"><?= $value->nama ?></a></span>
            ...
            <tr>
                ...
                <td class="text-center px-0 ">
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="<?= url ?>admin/detailProduk.php/?id=<?= $value->id_produk ?>"
