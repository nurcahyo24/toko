...
require 'template_produsen/header.php';
?>
<div class=" detail-produk p-3 mt-3 bg-primary text-light ">
    ...
    <div class="card w-100 text-dark my-3" style="width: 18rem;">
        <img style="" src=" <?= url ?>assets/images/produk/<?= $produk['produk']->gambar ?>"
            class="card-img-top m-auto w-25" alt="...">
        ...
        <div class="card w-100 text-dark ">
            ...
            <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group mx-2 col-sm-5 ">
                        ...
                        <input class="form-control " type="text" name="nama" id="nama"
                            value="<?= (isset($_SESSION['nama']) ? $_SESSION['nama'] : $produk['produk']->nama) ?>">
                    </div>
                    <div class="form-group mx-2 col-sm-5 ">
                        <label for="harga">harga</label>
                        <input class="form-control " type="number" name="harga" id="harga"
                            value="<?= (isset($_SESSION['harga']) ? $_SESSION['harga'] : $produk['produk']->harga) ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <div class="form-group mx-2 col-sm-5 ">
                        ...
                        <input class="form-control " type="number" name="stok" id="stok"
                            value="<?= (isset($_SESSION['stok']) ? $_SESSION['stok'] : $produk['produk']->stok) ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group mx-2 col-sm-5 ">
                        ...
                        <textarea class="form-control " type="text" name="deskripsi"
                            id="deskripsi"><?= (isset($_SESSION['deskripsi']) ? $_SESSION['deskripsi'] : $produk['produk']->deskripsi) ?></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class=" text-center my-3">
                    <button type="submit" name="ubah" class="btn btn-sm btn-primary w-25"
                        class="card-link">Simpan</button>
                    <a id="ubah-data-href" href="<?= url ?>produsen/produk.php?>" class="btn btn-sm btn-danger w-25"
                        class="card-link">Batal</a>
                </div>
            </form>
        </div>
    </div>
</div>
<?php require 'template_produsen/footer.php' ?>